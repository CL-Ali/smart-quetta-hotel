...
import { registerPortalRoutes } from "./middleware/portal";
...
async function startServer() {
  ...
  // Attach Socket.io to the HTTP server before any routes so the singleton
  // is available to all routers immediately.
  initIo(server);
